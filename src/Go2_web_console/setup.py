...
setup(
    ...
    description="Authenticated ROS 2 and Nav2 Web console for Unitree Go2.",
    license="Apache-2.0",
    tests_require=["pytest"],
    entry_points={
        "console_scripts": [
            "go2_console = go2_web_console.console_server:main",
            "go2_set_console_password = go2_web_console.set_console_password:main",
        ]
    },
)
